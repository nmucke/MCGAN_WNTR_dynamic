...
from training.train_adversarial_AE import TrainAdvAE
from models.adversarial_autoencoder import Generator, Critic, Encoder
...
if __name__ == '__main__':
    ...
    # Test
    test_data = pd.read_pickle('data/test_data_with_leak/network_7')
    leak = test_data['leak']
    ...
    for i in range(0, observations.shape[1], memory):
        ...
        gen_state = generator(z)[0].detach().cpu().numpy()
